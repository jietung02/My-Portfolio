  ...
  return (
    <section  id="home" className="flex flex-col w-full bg-violet-100 h-screen ">
      <div className="flex flex-col m-auto text-custom-dark-gray">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-semibold ">Hello, I&apos;m <span className="font-extrabold">Tung Jie Min</span>.</h1>
          <h2 className="text-lg md:text-xl font-medium mx-auto py-2 ">A Full Stack Developer</h2>
        ...
        >
          <Link href='#about' className="relative flex w-full justify-center mx-auto text-base md:text-lg font-semibold">Discover More About Me</Link>
