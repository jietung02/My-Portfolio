      ...
      <div className='flex flex-col xl:flex-row xl:items-center xl:justify-center h-full min-h-screen w-full p-20 xl:p-20 2xl:px-52 2xl:py-16'>
        ...
        >
          <div className='text-custom-dark-gray '>
            ...
            <div className='flex w-full justify-center text-lg mt-4'>
              <a
                href='/myresume.pdf'
                target='_blank'
                rel='noreferrer'
        ...
        >
          <div className='flex flex-col'>
            <div className='flex flex-row justify-center gap-6 xl:gap-8'>
              ...
              <div className="shrink-0 w-32 p-1 bg-gradient-to-r from-rose-200 via-fuchsia-200 to-indigo-200 rounded-full">
